...
# Create a line plot for monthly values w/ quarterly sum annotations
ggplot(low_performing_product, aes(x = DATE, y = QTY_B2_12, color = "QTY_B2_12")) +
  geom_line() +
  geom_point() +
  geom_line(aes(y = PROMO_B2_12, color = "PROMO_B2_12")) +
  geom_point(aes(y = PROMO_B2_12, color = "PROMO_B2_12")) +
  labs(title = "Monthly Values of QTY_B2_12 and PROMO_B2_12",
       x = "Date",
       y = "Values",
       color = "Legend") +
  scale_color_manual(values = c("QTY_B2_12" = "blue", "PROMO_B2_12" = "red")) +
  theme_minimal() +
  ...
  annotate("text", x = as.Date("2018-03-01"), y = max(low_performing_product$QTY_B2_12), label = "Q1 Sum", size = 4, color = "blue") +
  annotate("text", x = as.Date("2018-06-01"), y = max(low_performing_product$QTY_B2_12), label = "Q2 Sum", size = 4, color = "blue") +
  annotate("text", x = as.Date("2018-09-01"), y = max(low_performing_product$QTY_B2_12), label = "Q3 Sum", size = 4, color = "blue") +
  annotate("text", x = as.Date("2018-12-01"), y = max(low_performing_product$QTY_B2_12), label = "Q4 Sum", size = 4, color = "blue") +
  annotate("text", x = as.Date("2018-03-01"), y = max(low_performing_product$PROMO_B2_12), label = "Q1 Sum", size = 4, color = "red") +
  annotate("text", x = as.Date("2018-06-01"), y = max(low_performing_product$PROMO_B2_12), label = "Q2 Sum", size = 4, color = "red") +
  annotate("text", x = as.Date("2018-09-01"), y = max(low_performing_product$PROMO_B2_12), label = "Q3 Sum", size = 4, color = "red") +
  annotate("text", x = as.Date("2018-12-01"), y = max(low_performing_product$PROMO_B2_12), label = "Q4 Sum", size = 4, color = "red") +
